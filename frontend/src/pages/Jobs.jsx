                                ...
                                <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl mb-4 ${isDark ? 'bg-slate-900/50 border border-slate-700' : 'bg-slate-50 border border-slate-200'}`}>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${isDark ? 'bg-slate-800 border-slate-600 text-white placeholder-slate-500' : 'bg-slate-50 border-slate-400 text-slate-900 placeholder-slate-400 focus:bg-white'}`}
                                            placeholder="id"
